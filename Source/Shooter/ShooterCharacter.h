...
protected:
    ...
    */
    ...
    // Drops currently equipped weapon and eauips traceHitItem
    ...
    // Chechks to see if we have ammo of the EquippedWeapon's ammo type
    bool CarryingAmmo();

    // Called from Animation Blueprint with Grap Clip notify
    UFUNCTION(BlueprintCallable)
    void GrabClip();
...
private:
    ...
    // Bases turn rate, in deg/sec. Other scaling may affect final turn rate
    ...
    class UAnimMontage* HipFrieMontage;
    ...
    // Defalut camera field of view value
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Combat, meta = (AllowPrivateAccess = "true"))
    ...
    // Scene component to the attach to the Character's hand  during reloading
    UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = Combat, meta = (AllowPrivateAccess = "true"))
    ...
    // Blood splatter particle for melee hit
    UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = Combat, meta = (AllowPrivateAccess = "true"))
    ...
    // Chance of being stun when hit by an enemy;
    UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = Combat, meta = (AllowPrivateAccess = "true"))
    float StunChance;
    ...
    // True when only jump not just in air
    UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Movement", meta = (AllowPrivateAccess = "true"))
    bool bIsJump;

    // Character Jump Z Velocity 
    UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Movement", meta = (AllowPrivateAccess = "true"))
    float JumpZVelocity;

    // Enemies attacking the character
    UPROPERTY(VisibleAnywhere, Category = Combat, meta = (AllowPrivateAccess = "true"))
    TArray<class AEnemy*>AttackingEnemies;
...
public:
    ...
    FORCEINLINE bool GetIsJump() const { return bIsJump; }

    void AddAttackingEnemy(AEnemy* Enemy);
    void RemoveAttackingEnemy(AEnemy* Enemy);

    void HealedByPotion(float amount);
};
