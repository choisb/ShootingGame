...
void AItem::ItemInterp(float DeltaTime)
{
    ...
    {
        UE_LOG(LogTemp, Warning, TEXT("ItemInterp"));
        ...
        // Adding curve value to the Z component of th Initial Location (scaled by DeltaZ)
        ...
        SetActorRotation(ItemRotation, ETeleportType::TeleportPhysics);   // personally edited
        
        if (ItemScaleCurve)
        {
            const float ScaleCurveValue = ItemScaleCurve->GetFloatValue(ElapsedTime);
            // Set XYZ scale to ScaleCurveValue
...
void AItem::PlayPickupSound(bool bForcePlaySound /* false */)
{
    if (bForcePlaySound)
    {
        if (PickupSound)
...
void AItem::OnConstruction(const FTransform & Transform)
{
    ...
    if (RarityTableObject)
    {
        ...
        if (RarityRow)
        {
            ...
            AdditionalDamage = RarityRow->AdditionalDamage;
...
void AItem::PlayEquipSound(bool bForcePlaySound /* false*/)
{
...
void AItem::StartItemCurve(AShooterCharacter* Char, bool bForcePlaySound /* false */)
{
